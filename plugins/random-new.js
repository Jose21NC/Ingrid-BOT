...
conn.sendHydrated(m.chat, wm, null, pp, md, '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', null, null, [
...
conn.sendHydrated(m.chat, `✨ *AQUÍ TIENE EL CLIMA EN ESPAÑOL*`, wm, pp, md, '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', null, null, [
...
conn.sendHydrated(m.chat, `✨ *HERE IS THE WEATHER IN ENGLISH*`, wm, pp, md, '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', null, null, [
...
conn.sendHydrated(m.chat, `✨ *AQUI ESTÁ O TEMPO EM PORTUGUÊS*`, wm, pp, md, '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', null, null, [
['💙 𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝙀𝙨𝙥𝙖𝙣𝙤𝙡', `.clima ${text}`],
['💜 𝙀𝙣𝙜𝙡𝙞𝙨𝙝 𝙫𝙚𝙧𝙨𝙞𝙤𝙣', `.clima2 ${text}`],  
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']
], m,)}  
