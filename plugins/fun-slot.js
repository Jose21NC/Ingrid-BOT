...
🎰 | *RANURAS* | 🎰 
 ...
 ────────
🎰 |   *SLOTS*   | 🎰`
await conn.sendHydrated(m.chat, `${s}\n\n${end}`, wm, null, md, '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', null, null, [
...
if (command == 'slot') {       
await conn.sendHydrated(m.chat, `*Elija en que apostará ${apuesta}*`, wm, null, md, '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', null, null, [
