...
let str = `${wm}`
let oficial = `Comunícate con Mí Creador por Instagram!!, Solo por ese medio puede ayudarte sobre Temas de GataBot\n\nCommunicate with My Creator on Instagram!!, Only by that means can help you on GataBot Themes`

await conn.sendHydrated2(m.chat, str, oficial, pp, 'https://github.com/Jose21NC/Ingrid-BOT', '𝐢𝐧𝐠𝐫𝐢𝐝-𝐛𝐨𝐭', 'https://www.instagram.com/Jose21nc', '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', [
['☘ 𝙄𝙧 𝙖𝙡 𝙞𝙣𝙞𝙘𝙞𝙤 | 𝙂𝙤 𝙩𝙤 𝙨𝙩𝙖𝙧𝙩', '/menu'],
], m,)
}
handler.help = ['owner', 'creator']
handler.tags = ['info']
handler.command = /^(contacto|owner|creator|propietario|dueño|propietaria|dueño|cread|creador)$/i
